...
# and combined
morning = "cwd=`pwd`;d=`date '+%Y_%m_%d'`;morning='$cwd/morning.txt';new_m='$cwd/$d_1.txt';cp $morning $new_m;open $new_m;"
evening = "cwd=`pwd`;d=`date '+%Y_%m_%d'`;evening='$cwd/evening.txt';new_e='$cwd/$d_2.txt';cp $evening $new_e;open $new_e;"
